       ...
       <div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-4 ">
				...
				<div class="col-md-6 top-content1">	   
					<div id="demo-pie-4" class="pie-title-center" data-percent="16"> <span class="pie-value"></span> </div>
				</div>
				 <div class="clearfix"> </div>
				</div>
			</div>
			<div class="col-md-8 content-top-2">
				...
				<div class="content-color">
					<div class="content-ch"><p><i></i>Active </p><span>50%</span>
					<div class="clearfix"> </div>
					</div>
					<div class="content-ch1"><p><i></i>Inactive</p><span> 50%</span>
					<div class="clearfix"> </div>
					</div>
				</div>
				<!--graph-->
